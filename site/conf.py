...
BLOG_AUTHOR = "Yasuhiro Asaka"  # (translatable)
BLOG_TITLE = "Grauwoelfchen's Canvas"  # (translatable)
SITE_URL = "https://grauwoelfchen.at/"
BASE_URL = "https://grauwoelfchen.at/"
BLOG_EMAIL = "yasuhiro.asaka@grauwoelfchen.net"
BLOG_DESCRIPTION = "cat /dev/null"  # (translatable)
...
# (translatable)
# CATEGORIES_INDEX_PATH = "categories"
...
# (translatable)
LICENSE_IDENTIFIER = "CC-BY-NC-SA"
...
# (translatable)
CONTENT_FOOTER = '{license} &copy; {date} &nbsp;<a href="{about}">{author}</a>'
...
CONTENT_FOOTER_FORMATS = {
    DEFAULT_LANG: (
        (),
        {
            "about": 'https://grauwoelfchen.net/about',
            "author": BLOG_AUTHOR,
...
RSS_COPYRIGHT = '{license} © {date} <a href="{about}">{author}</a>'
RSS_COPYRIGHT_PLAIN = '{license} © {date} {author}'
